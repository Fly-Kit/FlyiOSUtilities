...
- (UIView *)createContainerView
{
    ...
    dialogContainer.layer.borderColor = [[UIColor colorWithRed:246.0/255.0 green:246.0/255.0 blue:246.0/255.0 alpha:1.0f] CGColor];
    dialogContainer.layer.borderWidth = 1.0f;
    ...
    lineView.backgroundColor = [UIColor colorWithRed:243.0/255.0 green:243.0/255.0 blue:243.0/255.0 alpha:1.0f];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if ((i+1) != [buttonTitles count]) {
            [closeButton addRightBorderWithColor:[UIColor colorWithRed:243.0/255.0 green:243.0/255.0 blue:243.0/255.0 alpha:1.0f] width:1.0f];
        }
